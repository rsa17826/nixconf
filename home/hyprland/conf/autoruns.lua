...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd(
		"sh -c 'gpu-screen-recorder -w screen -f 60 -a default_output -r 300 -c mp4 -k h264_vulkan -q 40000 -o ~/videos/flashback -bm cbr & echo $! > /tmp/gpu-screen-recorder-flashback.pid; wait $!'"
	)
	-- hl.exec_cmd(
	...
	hl.exec_cmd('sh -c "cd ~/BACKUPS && push --no-hooks"')
	-- hl.exec_cmd("xdm")
